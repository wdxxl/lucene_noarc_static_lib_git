...
@interface OrgApacheLuceneQueryParserFastCharStream ()

- (void)refill;

@end

__attribute__((unused)) static jchar OrgApacheLuceneQueryParserFastCharStream_readChar(OrgApacheLuceneQueryParserFastCharStream *self);

__attribute__((unused)) static void OrgApacheLuceneQueryParserFastCharStream_refill(OrgApacheLuceneQueryParserFastCharStream *self);

@implementation OrgApacheLuceneQueryParserFastCharStream

- (instancetype)initWithJavaIoReader:(JavaIoReader *)r {
  OrgApacheLuceneQueryParserFastCharStream_initWithJavaIoReader_(self, r);
  return self;
}

- (jchar)readChar {
  return OrgApacheLuceneQueryParserFastCharStream_readChar(self);
}

- (void)refill {
  OrgApacheLuceneQueryParserFastCharStream_refill(self);
}
...
- (void)Done {
  ...
  @catch (JavaIoIOException *e) {
    [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, err))) printlnWithNSString:JreStrcat("$@$", @"Caught: ", e, @"; ignoring.")];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgApacheLuceneQueryParserFastCharStream = { "FastCharStream", "org.apache.lucene.queryParser", ptrTable, methods, fields, 7, 0x11, 14, 6, -1, -1, -1, -1, -1 };
  return &_OrgApacheLuceneQueryParserFastCharStream;
}

@end

void OrgApacheLuceneQueryParserFastCharStream_initWithJavaIoReader_(OrgApacheLuceneQueryParserFastCharStream *self, JavaIoReader *r) {
  NSObject_init(self);
...
OrgApacheLuceneQueryParserFastCharStream *new_OrgApacheLuceneQueryParserFastCharStream_initWithJavaIoReader_(JavaIoReader *r) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneQueryParserFastCharStream, initWithJavaIoReader_, r)
}

OrgApacheLuceneQueryParserFastCharStream *create_OrgApacheLuceneQueryParserFastCharStream_initWithJavaIoReader_(JavaIoReader *r) {
  J2OBJC_CREATE_IMPL(OrgApacheLuceneQueryParserFastCharStream, initWithJavaIoReader_, r)
}

jchar OrgApacheLuceneQueryParserFastCharStream_readChar(OrgApacheLuceneQueryParserFastCharStream *self) {
  if (self->bufferPosition_ >= self->bufferLength_) OrgApacheLuceneQueryParserFastCharStream_refill(self);
  return IOSCharArray_Get(nil_chk(self->buffer_), self->bufferPosition_++);
}

void OrgApacheLuceneQueryParserFastCharStream_refill(OrgApacheLuceneQueryParserFastCharStream *self) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgApacheLuceneQueryParserFastCharStream)
