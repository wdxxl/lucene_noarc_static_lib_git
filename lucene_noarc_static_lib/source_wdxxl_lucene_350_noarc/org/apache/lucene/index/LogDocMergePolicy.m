...
- (jlong)sizeWithOrgApacheLuceneIndexSegmentInfo:(OrgApacheLuceneIndexSegmentInfo *)info {
  return [self sizeDocsWithOrgApacheLuceneIndexSegmentInfo:info];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "size", "LOrgApacheLuceneIndexSegmentInfo;", "LJavaIoIOException;", "setMinMergeDocs", "I" };
