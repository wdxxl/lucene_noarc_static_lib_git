...
//  source: jar:file:wdxxl_lucene_350.jar!org/apache/lucene/search/PhraseQueue.java
//
...
- (jboolean)lessThanWithId:(OrgApacheLuceneSearchPhrasePositions *)pp1
  ...
  if (((OrgApacheLuceneSearchPhrasePositions *) nil_chk(pp1))->doc_ == ((OrgApacheLuceneSearchPhrasePositions *) nil_chk(pp2))->doc_) if (pp1->position_ == pp2->position_) if (pp1->offset_ == pp2->offset_) {
